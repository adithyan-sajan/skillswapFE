    ...
    <div className="min-h-screen w-full bg-white dark:bg-[#111] text-black dark:text-white font-mono antialiased transition-colors duration-150 flex flex-col relative overflow-hidden">
      ...
      <nav className="fixed top-0 w-full h-16 bg-white/90 dark:bg-[#111]/90 backdrop-blur-md border-b-4 border-black dark:border-white z-50">
        <div className="max-w-screen-2xl mx-auto h-full flex items-center justify-between px-6 border-x-4 border-black dark:border-white">
          <div className="flex items-center gap-4">
            <Link to="/" className={`flex items-center gap-2 px-3 py-2 border-2 border-black dark:border-white rounded-xl bg-white dark:bg-[#111] hover:bg-slate-100 dark:hover:bg-neutral-900 transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] ${PRESS_ANIMATION}`}>
          ...
          <div className="flex items-center gap-3 relative z-50">
            ...
            <Link to="/auth" className={`px-4 py-2.5 text-xs flex items-center justify-center font-black border-2 border-black dark:border-white rounded-xl bg-black text-white dark:bg-white dark:text-black hover:opacity-90 uppercase transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] ${PRESS_ANIMATION}`}>
              Enter App
            </Link>
          </div>
        </div>
      ...
      <section className="w-full relative z-10 bg-slate-50/40 dark:bg-neutral-950/10 backdrop-blur-[2px] border-t-4 border-black dark:border-white">
        <div className="max-w-screen-2xl mx-auto border-x-4 border-black dark:border-white py-16 px-6">
          <motion.div variants={containerVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div variants={itemVariants}>
              <div className={`p-8 h-full flex flex-col gap-6 group ${SHARED_CARD_STYLE}`}>
                <div className="flex items-center justify-between border-b-2 border-black/10 dark:border-white/10 pb-4">
                  <span className="text-[11px] font-black px-3 py-1.5 bg-indigo-600 text-white dark:bg-orange-400 dark:text-black uppercase rounded-lg border-2 border-black dark:border-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)]">Path 01 // Free</span>
                  <EarnPathIcon />
                </div>
                <div>
                  ...
                  <ul className="text-[11px] font-black space-y-3 text-black/80 dark:text-white/80 bg-slate-50 dark:bg-neutral-900 p-5 border-2 border-black dark:border-white rounded-xl">
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600 dark:text-orange-400">•</span> Best for: People looking to share hobbies & build networks
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600 dark:text-orange-400">•</span> Cost: $0.00 (Only your time)
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600 dark:text-orange-400">•</span> Limit: Unlimited earnings
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <motion.div variants={itemVariants}>
              <div className={`p-8 h-full flex flex-col gap-6 group ${SHARED_CARD_STYLE}`}>
                <div className="flex items-center justify-between border-b-2 border-black/10 dark:border-white/10 pb-4">
                  <span className="text-[11px] font-black px-3 py-1.5 bg-black text-white dark:bg-white dark:text-black uppercase rounded-lg border-2 border-black dark:border-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)]">Path 02 // Fast Track</span>
                  <BuyPathIcon />
                </div>
                <div>
                  <h3 className="text-2xl font-black uppercase tracking-tight mb-3">Buy Tokens Directly</h3>
                  <p className="text-xs text-black/70 dark:text-white/70 font-bold leading-relaxed mb-6">Don't have time to teach right now but need to learn a skill immediately? Skip the line. You can buy Skill Tokens directly using standard credit cards or digital pay systems. This cash feeds back into the eco-system to fund server costs and reward community leaders.</p>
                  <ul className="text-[11px] font-black space-y-3 text-black/80 dark:text-white/80 bg-slate-50 dark:bg-neutral-900 p-5 border-2 border-black dark:border-white rounded-xl">
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600 dark:text-orange-400">•</span> Best for: Busy professionals needing instant advice
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600 dark:text-orange-400">•</span> Delivery: Instant wallet allocation
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600 dark:text-orange-400">•</span> Support: Includes session protection guarantees
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <section className="w-full relative z-10 border-t-4 border-black dark:border-white bg-indigo-600 dark:bg-orange-500 text-white dark:text-black">
        <div className="max-w-screen-2xl mx-auto border-x-4 border-black dark:border-white px-6 py-12">
          <motion.div variants={containerVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }}>
      ...
      <section className="w-full relative z-10 border-y-4 border-black dark:border-white bg-white/40 dark:bg-[#111]/40 backdrop-blur-[2px] flex-grow flex flex-col">
        <div className="max-w-screen-2xl mx-auto border-x-4 border-black dark:border-white px-6 py-16 flex-grow w-full">
          <motion.div variants={containerVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="mb-12">
          ...
          <motion.div variants={containerVariants} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.1 }} className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Tier 1 */}
            <motion.div variants={itemVariants}>
              <div className={`p-8 h-full flex flex-col justify-between ${SHARED_CARD_STYLE}`}>
                ...
                <div className="mt-10 border-t-2 border-black/10 dark:border-white/10 pt-6">
                  <div className="text-4xl font-black mb-6">
                    $3<span className="text-sm font-black text-black/40 dark:text-white/40"> / single</span>
                  </div>
            ...
            <motion.div variants={itemVariants}>
              <div className={`p-8 h-full flex flex-col justify-between relative overflow-hidden transform md:-translate-y-4 ${SHARED_CARD_STYLE}`}>
                <div className="absolute top-0 right-0 bg-indigo-600 text-white dark:bg-orange-400 dark:text-black font-black text-[10px] uppercase px-3 py-1.5 border-b-2 border-l-2 border-black dark:border-white rounded-bl-xl shadow-[-2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[-2px_2px_0px_0px_rgba(255,255,255,1)]">Best Starter</div>
                <div>
                ...
                <div className="mt-10 border-t-2 border-black/10 dark:border-white/10 pt-6">
                  <div className="text-4xl font-black mb-6">
                    $10<span className="text-sm font-black text-black/40 dark:text-white/40"> / save 33%</span>
                  </div>
            ...
            <motion.div variants={itemVariants}>
              <div className={`p-8 h-full flex flex-col justify-between ${SHARED_CARD_STYLE}`}>
                ...
                <div className="mt-10 border-t-2 border-black/10 dark:border-white/10 pt-6">
                  <div className="text-4xl font-black mb-6">
                    $20<span className="text-sm font-black text-black/40 dark:text-white/40"> / best value</span>
                  </div>
                  <Link to="/auth" className={`w-full py-3 bg-slate-50 dark:bg-neutral-900 hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black font-black uppercase text-xs border-2 border-black dark:border-white rounded-xl transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] flex items-center justify-center ${PRESS_ANIMATION}`}>
                    Select Path
                  </Link>
