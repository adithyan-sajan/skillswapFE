          ...
          <motion.div variants={containerVariants} initial="hidden" animate="show">
            ...
            <motion.div variants={itemVariants} className="mb-6">
              <h1 className="font-sans text-4xl md:text-7xl font-black tracking-tight leading-[1.05] uppercase text-black dark:text-white block">
                <TextType text={["Knowledge is Capital", "Exchange what you know", "Learn brand new skills"]} typingSpeed={75} pauseDuration={1500} showCursor cursorCharacter="_" deletingSpeed={50} variableSpeedEnabled={false} cursorBlinkDuration={0.5} />
              </h1>
            ...
            <motion.p variants={itemVariants} className="text-sm md:text-lg text-black/80 dark:text-white/80 max-w-2xl font-black leading-relaxed border-l-4 border-black dark:border-white pl-5 bg-white/90 dark:bg-[#111]/90 backdrop-blur-sm p-2 rounded-r-lg inline-block">
            ...
            <motion.div variants={itemVariants} className="mt-10 p-2 rounded-xl flex flex-col sm:flex-row items-center gap-3 max-w-md border-4 border-black dark:border-white bg-white dark:bg-[#111] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
              <Link to="/protocol" className="w-full sm:w-1/2 px-4 py-3 bg-white dark:bg-neutral-800 text-black dark:text-white font-black uppercase text-xs rounded-xl border-2 border-black dark:border-white text-center hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all">
                How It Works
              </Link>
          ...
          <div className="px-6">
            ...
            >
              {[
                ...
                /* WRAPPER PATTERN: Framer Motion animates the container, Tailwind styles the inner div */
                <motion.div key={idx} variants={itemVariants}>
                  <div className={`p-5 h-full ${SHARED_CARD_STYLE}`}>
